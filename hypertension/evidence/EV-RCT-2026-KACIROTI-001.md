...
grade:
  level: low
  reasons:
  - 源自大型RCT，但为事后机器学习二次分析，降一级
id: EV-RCT-2026-KACIROTI-001
journal: Journal of clinical hypertension (Greenwich, Conn.)
language: en
pico:
  population:
    condition: 收缩期高血压（需联合降压治疗）
    sample_size: 11506
  intervention:
    name: 贝那普利/氨氯地平（RASi+CCB 单片复方）
  comparison:
    name: 贝那普利/氢氯噻嗪（RASi+噻嗪类）
  outcomes:
    primary:
    - name: 主要复合心血管终点（心血管死亡、心肌梗死、卒中、住院心绞痛、心脏骤停复苏、冠脉血运重建）
    - name: 收缩压预测心血管事件的相对重要性（VIF）
pmid: '42130176'
risk_of_bias:
  tool: RoB2
  overall: some_concerns
  domains:
    reporting_bias: 事后分析，非预先注册
status: reviewed
tags:
- combination therapy
- ACCOMPLISH
...
title:
  ...
  zh: 联合降压方案改变心血管危险因素重要性：ACCOMPLISH试验的机器学习分析
type: RCT
year: 2026
study_type: COHORT
---
